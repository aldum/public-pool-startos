...
//           url: Value.text({
//             name: 'URL',
//             warning: `the domain of this URL must already exist in StartOS and be assigned to PubPool's HTTP interface`,
//             required: true,
//             default: null,
//             inputmode: 'url',
...
//       .getOwn(effects, sdk.StorePath.PUBPOOL__server__ROOT_URL)
//       .const()
...
//     sdk.store.setOwn(
//       effects,
//       sdk.StorePath.PUBPOOL__server__ROOT_URL,
